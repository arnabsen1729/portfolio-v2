---
title: 'Landing a Google SWE Internship: Interview Experience and Preparation Journey'
dek: 'A full breakdown of how I cracked Google''s off-campus SWE internship process, from resume building and referrals to DSA prep and interview strategy.'
date: 2023-04-04
tags: ['internships', 'software-development', 'tips', 'google']
---
...
Hi, I am Arnab Sen, a Software Developer from India 🇮🇳. I interned at Google as an SWE for the summer of 2022 and even grabbed a Pre-Placement Opportunity. I will join Google India as a Full Time, in July 2023. When I was in my third year Google, unfortunately, didn't visit our campus. So I had to take the <mark>off-campus</mark> route to land at Google and here is my journey:

![](/images/blog/landing-a-google-swe-internship/7280cea2-1be5-45ad-b8bf-c07b427764d0.jpeg)
...
It was in <mark>Aug 2021</mark> that I came across the Google India SWE Intern opening in [Google's career portal](https://careers.google.com/jobs) and I applied with a referral from one of my seniors.
...
Originally I used to create my resume in **LaTeX** but later on, it became a hassle to maintain and make updates. Hence I moved on to this website called [flowcv.com](https://flowcv.com/).
...
![I used the right most template to create my resume](/images/blog/landing-a-google-swe-internship/a00be9ab-5325-4961-b1ed-2d762e03f50b.png)

I prefer a **single-column** resume. If you want to stick to **LaTeX** and you are looking for a resume template, my suggestion would be to use [DeedyCV](https://www.overleaf.com/latex/templates/deedy-cv/bjryvfsjdyxz). It looks very professional and compact.

![](/images/blog/landing-a-google-swe-internship/cfbfe964-0a20-4710-85c2-aeb8d93923cd.png)
...
* **If you don't have achievements**, try to take part in Leetcode, GFG, Hackerrank, or HackerEarth contests or contests of college fests. You can put those ranks in your achievements. To know the upcoming contests, check out [clist.by](https://clist.by/).
    
* **If you don't have projects**, try to take part in hackathons with your peers. "I can't think of a good project" is what I hear from a lot of my juniors. Right now, if I ask you to think of anything, you won't be thinking of anything. But if I asked you to think of a fruit, you might be thinking of a banana, apple, mango, etc. Every hackathon has a unique theme, so by the end of the hackathon you will have a somewhat unique project. You can find such hackathons at [Devpost](https://devpost.com/).
...
If you are interested to know what my resume looks like, check out: [arnabsen.dev/resume](https://arnabsen.dev/resume).

#### Elevate your referral game

Companies like Google actually let their own employees refer potential candidates<Sidenote>At Google specifically, referrals go through an internal portal rather than just a forwarded resume — the referrer has to actively vouch for you in writing.</Sidenote>. Although a referral doesn't **necessarily guarantee you a job** offer, it does mean your **application will stand out** from the rest of the applicants, which can only mean one thing - your chances of getting hired just got a whole lot higher. In some cases, a **Good Resume + Referral** can fast forward in the application rounds. In my case, I was directly skipped to the Technical Interview rounds.
...
* I was lucky enough to have a senior in my college who was ready to refer me. We knew each other since day 1 of my college so he was able to write a good referral for me. Shoutout to [Suryansh Gupta](https://www.linkedin.com/in/surikumkaran/) ✨. So you can always reach out to your seniors regarding referrals.
...
* I also prepared by participating in Competitive Programming contests, especially from [Atcoder](https://atcoder.jp/) and [LeetCode](https://leetcode.com). This was done to ensure that I could answer the questions swiftly and within the time limit, exactly like an actual OA.
...
* [https://algo.monster/problems/google\_online\_assessment\_questions](https://algo.monster/problems/google_online_assessment_questions)
    
* [https://www.codingninjas.com/codestudio/problem-lists/top-google-coding-interview-questions](https://www.codingninjas.com/codestudio/problem-lists/top-google-coding-interview-questions)
    
* [https://www.interviewbit.com/google-interview-questions/](https://www.interviewbit.com/google-interview-questions/)
...
* Segment trees/Fenwick trees *(good to know)*<Sidenote>Fenwick trees (a.k.a. Binary Indexed Trees) are the more "OA-friendly" of the two — they're shorter to implement correctly under time pressure than a full segment tree.</Sidenote>
...
* How is a C++ `map` different from `unordered_map` from an implementation point of view?
...
1. [Introduction to Algorithm by CLRS (a.k.a the Bible of DSA)](https://sd.blackball.lv/library/Introduction_to_Algorithms_Third_Edition_(2009).pdf)
    

![](/images/blog/landing-a-google-swe-internship/afd6849a-e717-4220-8660-86f46d41632a.png)

1. [MIT 6.006 Introduction to Algorithms, Fall 2011](https://www.youtube.com/playlist?list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb)
    
    ![](/images/blog/landing-a-google-swe-internship/e2c4a5ee-c526-41e6-9c14-70aa166435f1.png)
...
It was on <mark>13th September</mark> I received a mail stating that I have my interview lined up after a week. I freaked out a little. Because first, I didn't expect to hear back from them. And second, how am I supposed to prepare for a Google interview in 7 days?

![](/images/blog/landing-a-google-swe-internship/dd626c79-24d1-4cff-881a-9ca080407529.png)
...
![](/images/blog/landing-a-google-swe-internship/b349c1fc-bda6-4903-ad35-04394cc293fa.png)
...
![](/images/blog/landing-a-google-swe-internship/3ed32d8a-003a-4021-a47f-e4e5e026de48.png)
...
[Link to the playlist 📼.](https://www.youtube.com/playlist?list=PLeXWGmu4fYL76f_nnnGyCu9Tr9k5NYtko)

![](/images/blog/landing-a-google-swe-internship/af5630e9-e9b0-4d51-a684-4caf97898c74.png)

I gave a bunch of mock interviews (around 5-6) by taking the help of my seniors and using online free platforms like [Pramp](https://www.pramp.com/invt/lYAEXB2Pa1Hxra4p3zMP).
...
Now, your first thought might be using Kandane's Algorithm<Sidenote>Kadane's algorithm finds the maximum-sum contiguous subarray in a single linear pass by tracking a running "best sum ending here."</Sidenote>. But wait, what if all the numbers are positive? In that case, the answer is simply the entire array. As you can see one small change in the constraints, had a big effect on the final solution. So always practice asking clarifying questions.
...
![](/images/blog/landing-a-google-swe-internship/1ac9e05e-b247-4408-b4c6-d203619806fd.png)

![](/images/blog/landing-a-google-swe-internship/0809eacd-3a5d-45e9-9d80-fb1f129ed7f8.png)
...
After I finished my interviews, I had a long wait. According to what I've heard, there is a hiring committee that comprises four to five persons that have prior interview experience and are familiar with the hiring standards<Sidenote>This is deliberately decoupled from the interviewers themselves — the committee reviews packets, not people, which is meant to reduce the influence of any single interviewer's personal impression.</Sidenote>. They would review your resume, your code during interviews, and the feedback from the interviewers before making a final decision.
...
<mark>"Congratulations on your SWE Summer Intern offer with Google India!"</mark>

![](/images/blog/landing-a-google-swe-internship/fcacca0a-ef4b-4c7a-9127-fc2d9345b183.png)
...
![What was the 'Connecting the dots theory' of Steve Jobs? - Quora](/images/blog/landing-a-google-swe-internship/main-qimg-c1e71c29e562ff5498718a64c3d287f0-lq.jpg)
...
[https://arnabsen.hashnode.dev/important-tips-on-bagging-ppo-during-internship-and-securing-a-full-time-role](https://arnabsen.hashnode.dev/important-tips-on-bagging-ppo-during-internship-and-securing-a-full-time-role)

You can learn more about me at [arnabsen.dev/about](https://www.arnabsen.dev/about). Have a nice day !!
